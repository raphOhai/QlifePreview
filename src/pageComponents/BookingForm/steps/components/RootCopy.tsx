        ...
        <div className='space-y-10'>
            ...
            <div className='space-y-8'>
                ...
                <div className='space-y-1'>
                    ...
                    <p className='text-[16px] font-weight-[400] leading-[24px] text-[#707070)]'>
                        A digital passport photo will be captured at the clinic.
                    </p>
                </div>
                ...
                <div className='space-y-1'>
                    ...
                    <p className='text-[16px] font-weight-[400] leading-[24px] text-[#707070)]'>
                        The registration for the screening starts at 8am to 1pm Monday to Friday, and Saturdays from 8am - 12noon,
                    </p>
                </div>
            </div>
        </div>
