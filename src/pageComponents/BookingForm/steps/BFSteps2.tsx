                ...
                <div className='col-span-5'>
                    <div className='space-y-4'>
                        <div className='space-y-2'>
                            <h2 className='text-[18px] font-weight-[500] text-[#0B0A0B]'>
                                Select Date & Time
                            </h2>

                            <div className='flex flex-row gap-1'>
                                <h1 className='text-[14px] font-weight-[500]  text-[#0B0A0B]'>
                                    Time zone:
                                </h1>
                                <p className='text-[14px] text-[#00186B]'>
                                    Lagos/Nigeria
                                </p>
                            </div>
...
const TimeOfDaySelect = () => {
    ...
    const TimeBox = ({ time }: { time: string }) => {
        return (
            <div className='flex flex-row gap-1 border-[1px] border-[#B8B8B8] p-[5px] items-center justify-center '>
                <h1 className='text-[20px] font-weight-[500] text-[#0B0A0B]'>
                    {time}
                </h1>
            </div>
        )
