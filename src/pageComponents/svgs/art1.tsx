...
export const Art1 = () => {
    return (
        <svg width="1098" height="351" viewBox="0 0 1098 351" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="436" cy="46" r="13" stroke="#00186B" stroke-width="6" />
            ...
            <circle cx="1020" cy="158" r="13" stroke="#00186B" stroke-width="6" />
            <rect x="1034" y="154" width="64" height="8" fill="#00186B" />
            <circle cx="407" cy="270" r="13" stroke="#00186B" stroke-width="6" />
            ...
            <circle cx="933" cy="270" r="13" stroke="#00186B" stroke-width="6" />
