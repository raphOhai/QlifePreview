...
export const ServicesPage = () => {
  return (
    <div className='space-y-4 py-[96px] px-[48px]'>
      <div className='space-y-4 px-[96px]'>
    ...
    <div>
        <Image src='/services/1.webp' alt='Root Services' width={2000} height={2000} className='w-full h-[550px] object-cover border-b-[10px] border-[#FFF16F]' />
    </div>
</div>
  )
}
