        ...
        <div className='space-y-4 py-12 md:py-16 lg:py-[96px] px-4 md:px-8 lg:px-[48px]'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 lg:gap-10'>
                <div className='md:col-span-7'>
                    <h1 className='text-3xl md:text-4xl lg:text-[48px] font-weight-[400] leading-tight lg:leading-[56px] font-hornbill text-[#00186B] w-full md:w-[80%]' >
            ...
            <div>
                <Image src='/about/1.webp' alt='General Clinic' width={2000} height={2000} className='w-full h-[300px] md:h-[450px] lg:h-[550px] object-cover border-b-[5px] md:border-b-[10px] border-[#FFF16F]' />
            </div>
        </div>
    )
}
